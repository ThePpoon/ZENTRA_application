...
# ================================================================
# HEAT STROKE — Additional Settings (Hybrid 3-Layer)
# ================================================================
# Layer 1: YOLOv8-pose
POSE_MODEL_ID       = "yolov8m-pose.pt"   # weights สำหรับ pose
POSE_CONFIDENCE     = 0.40

# Layer 3: Rule Engine thresholds
MOTIONLESS_WARN_SEC      = 15.0   # วินาที → warning
MOTIONLESS_EMERGENCY_SEC = 30.0   # วินาที → emergency

# Roboflow Fall model (fallback)
FALL_MODEL_ID = "fall-detection-ovjqo/5"